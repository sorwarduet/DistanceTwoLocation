...
export default class App extends Component {
  ...
  componentWillMount() {
    ...
    this.distanceTwoPoint(this.state.latCurrent, this.state.longCurrent, this.state.latLocation, this.state.longLocation);
  }
 ...
 */
  ...
  */
  ...
  distanceTwoPoint=() => {
      ...
      let distance = (Math.sin(radlatCureent) * Math.sin(radLatLocation)) + 
